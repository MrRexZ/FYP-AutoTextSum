...
def prepend_slow(infile, outfile, line):
    ...
    """
    with open(os.path.join(os.path.dirname(__file__), infile), 'r', encoding="utf-8") as fin:
...
pretrain_num_lines = {"glove.840B.300d.txt": 2196017, "glove.42B.300d.txt": 1917494, "glove.6B.50d.txt": 400001}
